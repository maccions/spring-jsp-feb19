      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="box grid recipes">
            <div class="by"><i class="fa fa-user" aria-hidden="true"></i> Gerina Amy</div>
            <a href="recipe-detail.html">
              <img src="/res/images/recipe2.jpg" alt="">
            </a>
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="box grid recipes">
            <div class="by"><i class="fa fa-user" aria-hidden="true"></i> Gerina Amy</div>
            <a href="recipe-detail.html">
              <img src="/res/images/recipe3.jpg" alt="">
            </a>
            <h2><a href="recipe-detail.html">Pink Happy Pia Chocolate Sweet</a></h2>
            <p>Ur mission is to bring you and your family healthy organic & natural produce, and to support our local farmers and community. Our menu changes weekly according to what's fresh, local, and in season..</p>
            <div class="tag">
              <a href="#">Chocolate</a>
              <a href="#">Lemon</a>
              <a href="#">Sayur</a>
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="box grid recipes">
            <div class="by"><i class="fa fa-user" aria-hidden="true"></i> Gerina Amy</div>
            <a href="recipe-detail.html">
              <img src="/res/images/recipe4.jpg" alt="">
            </a>
            <h2><a href="recipe-detail.html">Tasty Muffin Sweet Tin Lunches</a></h2>
            <p>Muffin Tin Customizable Veggie Egg Cups. ... In a greased muffin tin, place your desired combination of fillings into each muffin cup. ... Sweet Potato Hash Cups</p>
            <div class="tag">
              <a href="#">Muffin</a>
              <a href="#">Lemon</a>
              <a href="#">Sayur</a>
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="box grid recipes">
            <div class="by"><i class="fa fa-user" aria-hidden="true"></i> Gerina Amy</div>
            <a href="recipe-detail.html">
              <img src="/res/images/recipe5.jpg" alt="">
            </a>
            <h2><a href="recipe-detail.html">Chickpea Recipes to Make Your Heart Happy</a></h2>
            <p>Happy Hearted Kitchen, Whole Foods. Whole Grains. Whole Hearted.</p>
            <div class="tag">
              <a href="#">Chicken</a>
              <a href="#">Lemon</a>
              <a href="#">Sayur</a>
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="box grid recipes">
            <div class="by"><i class="fa fa-user" aria-hidden="true"></i> Gerina Amy</div>
            <a href="recipe-detail.html">
              <img src="/res/images/recipe6.jpg" alt="">
            </a>
            <h2><a href="recipe-detail.html">Cornbread Topped Cast-Iron Skillet Chili</a></h2>
            <p>All Purpose Flour, Yellow Cornmeal, Granulated Sugar,...</p>
            <div class="tag">
              <a href="#">Corn</a>
              <a href="#">Lemon</a>
              <a href="#">Sayur</a>
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="box grid recipes">
            <div class="by"><i class="fa fa-user" aria-hidden="true"></i> Gerina Amy</div>
            <a href="recipe-detail.html">
              <img src="/res/images/recipe7.jpg" alt="">
            </a>
            <h2><a href="recipe-detail.html">Easy Vegan Weeknight Dinner Recipes</a></h2>
            <p>asy Vegan Weeknight Dinner Recipes. This list is not meant to be a comprehensive roundup of vegan meal ideas. These are the actual vegan weeknight dinners that my family eats.</p>
            <div class="tag">
              <a href="#">Vegan</a>
              <a href="#">Lemon</a>
              <a href="#">Sayur</a>
